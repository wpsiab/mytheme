    ...
    <div class="page_title_banner blog_grid_title_bg">
        ...
        <div class="container">
            <div class="page_title_banner_text text-center">
                <h2 class="banner_effect">Blog Grid</h2>
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="single_blog_item_area blog_grid_item para_default image_fulwidth text-center">
                        <a href="blog-single.html"><img src="images/blog_grid_img_01.jpg" alt="images"></a>
                        <h4>25 JUNE 2017</h4>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single_blog_item_area blog_grid_item para_default image_fulwidth text-center">
                        <a href="blog-single.html"><img src="images/blog_grid_img_02.jpg" alt="images"></a>
                        <h4>12 JULY 2017</h4>
                        <h3><a href="blog-single.html">We are the best company</a></h3>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                    </div>
                </div><!-- col-md-4-->
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single_blog_item_area blog_grid_item para_default image_fulwidth text-center">
                        <a href="blog-single.html"><img src="images/blog_grid_img_03.jpg" alt="images"></a>
                        <h4>30 JULY 2017</h4>
                        <h3><a href="blog-single.html">Improve employes skills</a></h3>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                    </div>
                </div><!-- col-md-4-->
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single_blog_item_area blog_grid_item para_default image_fulwidth text-center">
                        <a href="blog-single.html"><img src="images/blog_grid_img_04.jpg" alt="images"></a>
                        <h4>23 JAN 2017</h4>
                        <h3><a href="blog-single.html">Create great WordPress theme</a></h3>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                    </div>
                </div><!-- col-md-4-->
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single_blog_item_area blog_grid_item para_default image_fulwidth text-center">
                        <a href="blog-single.html"><img src="images/blog_grid_img_05.jpg" alt="images"></a>
                        <h4>19 JULY 2017</h4>
                        <h3><a href="blog-single.html">Retail banks wake up to digital</a></h3>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                    </div>
                </div><!-- col-md-4-->
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single_blog_item_area blog_grid_item para_default image_fulwidth text-center">
                        <a href="blog-single.html"><img src="images/blog_grid_img_06.jpg" alt="images"></a>
                        <h4>27 JULY 2017</h4>
                        <h3><a href="blog-single.html">We are the best company</a></h3>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                    </div>
            ...
            <div class="blog_pagination">
                <nav>
                    <ul class="pagination pagination-lg">
                        ...
                        <li class="page-item"><a class="page-link" href="blog-grid-2.html">2</a></li>

                        <li class="page-item">
                            <a class="page-link" href="blog-grid-2.html"><i class="flaticon-right-arrow"></i></a>
                        </li>
                    </ul>
                </nav>
            </div>

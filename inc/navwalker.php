	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
			...
			* a 0 if the strings are equal.
			...
			if ( 0 === strcasecmp( $item->attr_title, 'divider' ) && 1 === $depth ) {
				...
				elseif ( $args->has_children && 1 === $depth ) {
					$atts['href']   		= '#';
					$atts['data-toggle']	= 'dropdown';
					$atts['class']			= 'dropdown-toggle sub';
					$atts['aria-haspopup']	= 'true';
					$atts['aria-expanded']	= 'false';
				}
		...
		public static function fallback( $args ) {
			if ( current_user_can( 'edit_theme_options' ) ) {
				...
				$barrister_data_in = $args['barrister_data_in'];
				$barrister_data_out = $args['barrister_data_out'];
				...
				//edit
				if ( $barrister_data_in ) {
					echo ' data-in="' . esc_attr( $barrister_data_in ) . '"'; }
				if ( $barrister_data_out ) {
					echo ' data-out="' . esc_attr( $barrister_data_out ) . '"'; }
				echo '>';
